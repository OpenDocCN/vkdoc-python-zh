...
*   3.4.2\. 一次赋多值
    ...
    *   [*How to Think Like a Computer Scientist*](http://www.ibiblio.org/obp/thinkCSpy/ "Python book for computer science majors") 演示了如何使用多变量赋值来[交换两个变量的值](http://www.ibiblio.org/obp/thinkCSpy/chap09.htm)。
*   3.5\. 格式化字符串
