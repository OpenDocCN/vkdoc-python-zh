...
| 墙壁适配器 9V(可选) | [T0](http://www.sparkfun.com/products/) | $5.95 | 每个节点 1 个** |
...
| XBee Explorer 用标题<sup>调节[10](#Fn10)</sup> | [`www.sparkfun.com/products/11373`](http://www.sparkfun.com/products/11373) | $10.95 | 每个传感器节点 1 个 Raspberry Pi 个 |
